    ...
    <div class="top-header">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 customer"> <a href="index.php?controller=login"><i class="fa fa-user"></i> Đăng nhập</a> <a href="index.php?controller=register"><i class="fa fa-user-plus"></i> Đăng ký</a> </div>
            </div>
        </div>
    </div>
    <!-- end top header -->
